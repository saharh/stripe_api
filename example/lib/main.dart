          ...
          child: SingleChildScrollView(
            child: new Column(
              children: <Widget>[
                ...
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _startSession, child: new Text('Start Session')),
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _getCustomer, child: new Text('Get Customer')),
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _endSession, child: new Text('End Session')),
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _saveCard, child: new Text('Save Card')),
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _changeDefaultCard, child: new Text('Change Default')),
                new SizedBox(height: 12.0),
                new TextButton(onPressed: _deleteCard, child: new Text('Delete Card')),
                new TextButton(onPressed: _createCardSource, child: new Text('Create Source from Card')),
                new TextButton(onPressed: _createAliPaySource, child: new Text('Create Source from AliPay')),
                new TextButton(onPressed: _googlePay, child: new Text('Google Pay')),
                new TextButton(onPressed: _applePay, child: new Text('Apple Pay')),
                new TextButton(onPressed: _formatCard, child: new Text('Format Card')),
                new SizedBox(height: 12.0),
              ],
            ),
          ),
